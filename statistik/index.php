...
<body>
    ...
    <div class="main-content">
        ...
        <!-- Navbar -->
        <nav class="navbar top-navbar navbar-expand" style="left:0;right:0;width:100%">
                        ...
                        <div class="dropdown-menu">
                            <div class="dropdown-footer">
                                <ul>
                                    ...
                                    <li><a class="dropdown-item" href="../manager/tambah.php">Tambah Task</a></li>
        ...
        $(document).ready(function() {
            $.ajax({
                ...
                success: (result) => {
                    ...
                    let task = result.map((item) => item.total_task)
                    let comben = result.map((item) => item.total_comben)
                    let project = result.map((item) => item.total_project)
                    ...
                    result.forEach((element, index) => {
                        ...
                        <tr class="isi_tabel" id="pekerja_1_${index}">
                            ...
                            <div id="progress-bar-container">
                                ...
                                <div style="font-size: 12px;text-align: center;position: absolute;top: 0;left: 50%;right:50%;">${(parseInt(element.total_done) / parseInt(element.total_task) * 100).toFixed(2)}%</div>
                            </div>
                            </td>
                        </tr>`
